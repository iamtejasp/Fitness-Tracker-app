  ...
  return (
    <Screen>
      ...
      <RemoteImageBackground
        source={{ uri: imageUrls.dashboard }}
        style={styles.hero}
      ...
      >
        ...
        <Text style={styles.heroBody}>
          Log a workout and your stats will refresh automatically.
        </Text>
      </RemoteImageBackground>
      {statsQuery.isLoading ? (
        ...
        <View style={styles.statGrid}>
          ...
          <StatCard
            label="Top exercise"
            value={stats?.mostFrequentExercise ?? "None"}
            icon="trophy-outline"
            accent={colors.cyan}
          />
        </View>
      ...
      <View style={styles.sectionHeader}>
        ...
        <Link href="/(tabs)/workouts" style={styles.viewAll}>
          View all
        </Link>
      </View>
...
const styles = StyleSheet.create({
  ...
  heroBody: { color: "#DDE6F2", fontSize: 14, marginTop: 8 },
