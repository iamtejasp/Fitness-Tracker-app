...
const styles = StyleSheet.create({
  ...
  copy: { gap: 14 },
  kicker: { color: '#B7FF8A', fontSize: 13, fontWeight: '900', textTransform: 'uppercase' },
  title: { color: '#FFFFFF', fontSize: 40, fontWeight: '900', letterSpacing: 0, lineHeight: 46 },
  body: { color: '#DDE6F2', fontSize: 16, lineHeight: 24 },
  actions: { gap: 12 },
